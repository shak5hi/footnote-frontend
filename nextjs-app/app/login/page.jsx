  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.imageSide}>
        <img src="/images/login.jpg" alt="Footnote" className={styles.bgImage} />
        <div className={styles.imageOverlay} />
        <div className={styles.imageContent}>
          <div className={styles.wordmark}>FOOTNOTE</div>
          <blockquote className={styles.pullQuote}>
            &ldquo;Sound, not as distraction&mdash;<br />
            <em>but as architecture.</em>&rdquo;
          </blockquote>
        </div>
      </div>
      ...
      <div className={styles.formSide}>
        <div className={styles.formWrap}>
          ...
          <h1 className={styles.heading}>
            {mode === 'login' ? 'Welcome back.' : 'Join Footnote.'}
          </h1>
          <p className={styles.subheading}>
            {mode === 'login'
              ? 'Enter the frequency where you left off.'
              : 'For those who think in long-form.'}
          </p>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <button type="submit" className={styles.submitBtn}>
              {mode === 'login' ? 'Enter FR →' : 'Create account →'}
            </button>
          </form>
